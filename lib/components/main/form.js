        ...
        return (<div className='lt-form-wrapper'>
            ...
            <form className='lt-form' onSubmit={e=>{
                ...
                <div className='lt-form__fields'>
                    <div className='lt-form__field' >
                        <input type='text' name='name' placeholder='Name' onChange={e=>{this.handleChange('authorName',e)(e);}} />
                    </div>
                    <div className='lt-form__field'>
                        <input type='email' name='email' placeholder='Email'onChange={e=>{this.handleChange('authorEmail',e)(e);}}/>
                    </div>
                    <div>
